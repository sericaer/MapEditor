...
namespace HoneyFramework
{
    ...
    public class Chunk : ISerializable
    {
        ...
        static public Vector2i WorldToChunkVector2(Vector3 world3DPos)
        {
            Vector2 pos2d = VectorUtils.Vector3To2D(world3DPos);
            pos2d /= ChunkSizeInWorld;
            Vector2i pos2di = new Vector2i(Mathf.RoundToInt(pos2d.x), Mathf.RoundToInt(pos2d.y));
