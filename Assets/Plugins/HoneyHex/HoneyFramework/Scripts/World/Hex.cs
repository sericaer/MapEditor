...
namespace HoneyFramework
{
    ...
    public class Hex : ISerializable
    {
        ...
        public void RebuildChunksOwningThisHex()
        {
            ...
            var vector2 = Chunk.WorldToChunkVector2(new Vector3(xMin, 0f, yMin));
            ...
            World.GetInstance().PrepareChunkData(vector2);
            c = World.instance.chunks[vector2];
            chunks.Add(c);
            FogOfWar.ChunkUpdate(c, true);

            vector2 = Chunk.WorldToChunkVector2(new Vector3(xMin, 0f, yMax));
            World.GetInstance().PrepareChunkData(vector2);
            c = World.instance.chunks[vector2];
            chunks.Add(c);
            FogOfWar.ChunkUpdate(c, true);

            vector2 = Chunk.WorldToChunkVector2(new Vector3(xMax, 0f, yMax));
            World.GetInstance().PrepareChunkData(vector2);
            c = World.instance.chunks[vector2];
            chunks.Add(c);
            FogOfWar.ChunkUpdate(c, true);
